...
object PensionSchemeAdministrator {
  ...
  val psaUpdateWrites: Writes[PensionSchemeAdministrator] = psaWrites(isUpdate = true)
  val psaSubmissionWrites: Writes[PensionSchemeAdministrator] = psaWrites(isUpdate = false)
