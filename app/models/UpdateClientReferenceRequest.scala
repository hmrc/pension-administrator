...
case class IdentifierDetails(identifierDetails:UpdateClientReferenceRequest)

object IdentifierDetails {
  implicit val identifierDetailsFormat: OFormat[IdentifierDetails] = Json.format
}
